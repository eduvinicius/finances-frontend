...
export function Login() {
  ...
  const { isPending: googlePending } = useGoogleLogin();
  ...
  return (
    <div className="flex flex-col-reverse md:grid md:grid-cols-3 h-screen items-center justify-items-center px-4 md:px-0 gap-6 md:gap-0">
